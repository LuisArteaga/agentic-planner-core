...
- Reference implementation: `agentic-developer-core/config/sources.toml`, `config/sources.example.toml`, `orchestrator/sources_config.py` (developer-core ADR-0017).
